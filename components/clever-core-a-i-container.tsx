...
const CleverCoreAIContainer: NextPage = () => {
  return (
    <div className="absolute top-[0px] left-[0px] bg-lavender w-[1440px] h-[722px] overflow-hidden text-left text-20xl text-black-button font-body">
      <TypeBrowser
        bar="/bar1.svg"
      ...
      <ButtonPrimary
        ...
        propLeft="unset"
      />
      <div className="absolute top-[61px] left-[calc(50%_-_191px)] rounded-8xs bg-lavender flex flex-row py-0 px-6 items-start justify-start gap-[24px] text-base">
        ...
        <div className="h-12 flex flex-row items-center justify-start">
          <div className="relative leading-[150%] font-medium">About</div>
        </div>
        <div className="h-12 flex flex-row items-center justify-start">
...
export default CleverCoreAIContainer;
